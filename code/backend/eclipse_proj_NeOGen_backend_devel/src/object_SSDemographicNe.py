...
class object_SSDemographicNe(object):
    """Contains SS Simulation level properties and methods"""
    def __enter__(self):

        class obj_SSDemographicNe():
...
# -------------- Class specific routines
            ...
            def __init__(self):
                ...
                self.dictPropertyDicts = AutoVivificationHandler()
...
#                 dictProperty = {}
                ...
                self.dictPropertyDicts[listPropertyLabels[0]] = dictProperty
                ...
                for itemVirtualSubPop in self.listVirtSubPopsToOutput:
                    ...
                    self.intVirtualSubPop = int(re__findall( r'\,(.*?)\)', str(self.listSingleVirtualSubPop))[0])
                    '''
                    >>>>>>> Assign Properties <<<<<<<<
                    '''
...
# -------------- Class specific routines
        ...
        self.class_obj_SSDemographicNe = obj_SSDemographicNe() 
        return self.class_obj_SSDemographicNe
 
    def __exit__(self, type, value, traceback): 
        self.class_obj_SSDemographicNe.classCleanUp()