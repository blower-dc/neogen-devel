...
qtDesigner_QWidget_Slider_Sample_Proportions = uic.loadUiType("SharkSimFE_CUSTOM_WIDGET_DOUBLE_SPINBOX_SLIDER_SS.ui")[0]  
...
class Ui_QWidget_Slider_Sample_Proportions(QtGui.QWidget, qtDesigner_QWidget_Slider_Sample_Proportions):
    '''
    classdocs
    '''
    __slots__ = (
               ...
               ,'prop_bool_On_Check__Set_Widget_Max'
               )
    ...
    def func_Initialise_Class(self):
        ...
        self.bool_On_Check__Set_Widget_Max = False
        ...
        self.bool_On_Check__Set_Widget_Max = self.prop_bool_On_Check__Set_Widget_Max
    ...
    def func_Bind_Event_Handlers__QCheckBox(self):
        ...
        '''QCheckBox - Select '''
        self.checkBox.stateChanged["int"].connect(self.func_QCheckBox__StateChanged)
    ...
    def func_QCheckBox__StateChanged(self, int_State):
        ...
        if self.checkBox.isChecked():
            if self.prop_bool_On_Check__Set_Widget_Max:
                self.doubleSpinBox.setValue(self.float_DoubleSpinBox__Max)
            pass
        else:
            if self.prop_bool_On_Check__Set_Widget_Max:
                self.doubleSpinBox.setValue(self.int_Slider__Default_Value)
            pass
        pass
