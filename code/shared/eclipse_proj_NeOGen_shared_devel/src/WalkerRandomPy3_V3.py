...
if __name__ == "__main__":
    ...
    #To disply the weights only
    listWeights = []
    for x in range( 1, N ):
      listWeights.append(x/10)
      
    print("\n" + str(Nrand) + " Walkerrandom with weights - ", end="")
    print ("w = " + str(listWeights))
    ...
    print("\n" + str(Nrand) + " Walkerrandom strings with weights: ", end="")
    print (str(dict( Age1=1, Age5=4, Age3=3, Age2=2 )))
    abcd = dict( A=1, D=4, C=3, B=2 )
    wrand = Walkerrandom( abcd.values(), list(abcd.keys()) )
