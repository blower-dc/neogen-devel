...
#  
        ...
        for tuple_Logger_Name in list_tuple_Logger_Specs: 
            self.func_Initialise(tuple_Logger_Name)
        pass
    
            
    def func_Initialise(self, tuple_Logger_Name):
...
#             
#             if self.bool_LogToConsole == False:
#                 #Prevent the root logger from logging
#                 self.obj_Internal_Logger.propagate = False
...
#         pass
        ...
        if self.bool_LogToFile:
            if self.strLogFile == '':
                ...
                #self.obj_Internal_Logger.info('Logging to FILE enabled')
            pass
        else:
