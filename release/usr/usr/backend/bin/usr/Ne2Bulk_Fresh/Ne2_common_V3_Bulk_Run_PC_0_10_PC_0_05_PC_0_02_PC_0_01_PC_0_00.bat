...
:process_PC10
type Ne2_common_V3_PC10.param1 > Ne2_common_V3_PC10.param_run
type Ne2_Bulk_Filenames.txt >> Ne2_common_V3_PC10.param_run
type Ne2_common_V3_PC10.param2 >> Ne2_common_V3_PC10.param_run
del Ne2_common_V3_Bulk_Run_PCrit_0_05.FAILED
del Ne2_common_V3_Bulk_Run_PCrit_0_05.COMPLETE
del Ne2_common_CAOB_V3_PC10xLD.txt
del Ne2_common_CAOB_V3_PC10.out
Ne2 c:Ne2_common_V3_PC10.param_run
IF %ERRORLEVEL% NEQ 0 (
goto :error_PC10 
) else (
goto :complete_PC10
...
:error_PC10
echo Ne2_common_V3_Bulk_Run_PCrit_0_10 Failed with error #%errorlevel%. > Ne2_common_V3_Bulk_Run_PCrit_0_10.FAILED
goto :process_PC5

:complete_PC10
echo Ne2_common_V3_Bulk_Run_PCrit_0_10 Completed successfully. > Ne2_common_V3_Bulk_Run_PCrit_0_10.COMPLETE
goto :process_PC5
