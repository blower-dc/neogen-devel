...
--------------------------
Please cite as:
Blower, D, Riginos, C, & Ovenden, JO (submitted) NeOGen: a tool to predict genetic effective population size (Ne) for species with generational overlap and to assist empirical Ne study design. Molecular Ecology Resources

LICENCE
-------------------------
The Alpha and Beta versions of this software are currently Draft, Confidential, & Copyright Dean Blower 2018 All Rights Reserved.
Future stable releases (i.e. not alpha or beta test versions) will be licenced with a GNU General Public License (GPL) licence.
...
6. You're done! Start exploring the wonder of NeOGen-Power. Reading the guides will help ;o). The user manual (i.e. help file, guide 0) is displayed alongside the main app when its launched.
